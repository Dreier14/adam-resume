    ...
    render() {
        ...
        <div>
            ...
            <div className= "mailer-form">
                ...
                <div>
                    <h2 className= 'long'>Contact Me</h2>
                    <hr/>
                <div className='align'>
                    <div className="contact">
                        <form className="mailer" >
                            ...
                            <label htmlFor="message">
                                ...
                                <textarea background="white" className="edit-space" onChange={ event =>this.handleChange(event.target.value)} onChange={ event => this.messageHandler(event.target.value)} name="message" required value={this.state.message}/>
                            </label>
                            </div>
